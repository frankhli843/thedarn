...
from thedarn import corrector, const
from thedarn.system import Path
from thedarn.types import Command
from thedarn.corrector import get_corrected_commands, organize_commands


@pytest.fixture
def glob(mocker):
    results = {}
    mocker.patch('thedarn.system.Path.glob',
...
class TestGetRules(object):
    ...
    def load_source(self, monkeypatch):
        monkeypatch.setattr('thedarn.types.load_source',
                            lambda x, _: Rule(x))
