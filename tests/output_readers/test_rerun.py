...
from thedarn.output_readers import rerun


class TestRerun(object):
    def setup_method(self, test_method):
        self.patcher = patch('thedarn.output_readers.rerun.Process')
    ...
    @patch('thedarn.output_readers.rerun._wait_output', return_value=False)
    @patch('thedarn.output_readers.rerun.Popen')
    ...
    @patch('thedarn.output_readers.rerun._kill_process')
    ...
    @patch('thedarn.output_readers.rerun.logs')
