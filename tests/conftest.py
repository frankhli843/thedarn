import os
import pytest
from thedarn import shells
from thedarn import conf, const
...
def no_memoize(monkeypatch):
    monkeypatch.setattr('thedarn.utils.memoize.disabled', True)
...
def no_cache(monkeypatch):
    monkeypatch.setattr('thedarn.utils.cache.disabled', True)
...
def set_shell(monkeypatch):
    def _set(cls):
        shell = cls()
        monkeypatch.setattr('thedarn.shells.shell', shell)
        return shell
