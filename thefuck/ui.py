...
class CommandSelector(object):
    ...
    def __init__(self, commands):
        """:type commands: Iterable[thedarn.types.CorrectedCommand]"""
    ...
    @property
    def value(self):
        """:rtype thedarn.types.CorrectedCommand"""
...
def select_command(corrected_commands):
    ...
    :type corrected_commands: Iterable[thedarn.types.CorrectedCommand]
    :rtype: thedarn.types.CorrectedCommand | None

    """
    try:
        selector = CommandSelector(corrected_commands)
    except NoRuleMatched:
        logs.failed('No darns given' if get_alias() == 'darn'
                    else 'Nothing found')
        return
